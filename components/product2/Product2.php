													...
													<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
														<form action="#" method="post">
															<fieldset>
																...
																<input type="hidden" name="cancel_return" value=" " />
																<?php
																echo "<p align = 'center'><a href='addcart.php?id=$ii[MASP]'>Thêm vào giỏ hàng</a></p>";
																?>
															</fieldset>
														</form>
													</div>
							...
							foreach($rowsdata3 as $iii){
								?>
									<div class="col-md-4 product-men">
											<div class="men-pro-item simpleCart_shelfItem">
												<div class="men-thumb-item text-center">
													<img src="<?php echo $level.img_path?><?php echo $iii["TENFILE"] ?>" alt="" class="img-fluid">
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
													...
													<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
														<form action="#" method="post">
															<fieldset>
																...
																<input type="hidden" name="cancel_return" value=" " />
																<?php
																	echo "<p align = 'center'><a href='addcart.php?id=$iii[MASP]'>Thêm vào giỏ hàng</a></p>";
																?>
															</fieldset>
														</form>
													</div>
									...
									<div class="col-md-4 product-men">
										<div class="men-pro-item simpleCart_shelfItem">
											<div class="men-thumb-item text-center">
												...
												<div class="men-cart-pro">
													<div class="inner-men-cart-pro">
														<a   href="<?php echo $level.pages_path.'detail.php?id='.$iiii["MASP"]?>" class="link-product-add-cart">Xem Sản Phẩm</a>
													</div>
												</div>
											</div>
											<div class="item-info-product text-center border-top mt-4">
												<h4 class="pt-1">
													<a  href="<?php echo $level.pages_path?>single.php"><?php echo $iiii["TENSP"] ?></a>
												</h4>
												<div class="info-product-price my-2">
													<span class="item_price"><?php echo number_format( $iiii["GIA_BAN"],2)."VNĐ" ?></span>
													<del><?php echo number_format( $iiii["GIA_BAN"]*1.1,2)."VNĐ" ?></del>
												</div>
												<span class="product-new-top">New</span>
												<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
													<form action="#" method="post">
														<fieldset>
															...
															<input type="hidden" name="add" value="1" />
															<input type="hidden" name="business" value=" " />
															<input type="hidden" name="item_name" value="<?php echo $iiii["TENSP"] ?>" />
															<input type="hidden" name="amount" value="<?php echo number_format( $iiii["GIA_BAN"],2)."VNĐ" ?>" />
															<input type="hidden" name="discount_amount" value="449.00" />
															<input type="hidden" name="currency_code" value="USD" />
															<input type="hidden" name="return" value=" " />
															<input type="hidden" name="cancel_return" value=" " />
															<?php
																	echo "<p align = 'center'><a href='addcart.php?id=$iiii[MASP]'>Thêm vào giỏ hàng</a></p>";
															?>
														</fieldset>
													</form>
												</div>
