...
<?php
    ...
    AND (MALOAI = '" .$tsp. "' or MASP like '%" .$tsp. "%' or MA_NCC like '%" .$tsp. "%')");
    $result ->execute();
    $rowdata = $result->fetchAll();
    //echo 'tesstingggggggggggggg'
?>  
        ...
        <table class="table table-bordered dataList">
            ...
            ?>
                <tr align="center">
                    ...
                    <td class="align-middle delete"><a type="button" href="<?php echo $level . comp_path . 'product/deleteProduct.php?id=' . $sp['MASP']; ?>" style="padding: 100% 2px;"> <i class="bx bx-x delete"></i></a></td>
                </tr>
            <?php
            }
            ?>
